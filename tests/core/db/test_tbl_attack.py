...
from core.utilities.db.tbl_attack import get_all_attacks, get_attack_by_url, insert_attack, update_attack
...
def test_get_all_attacks(mocker):
  mocker.patch('core.utilities.db.base.execuate', return_value=FakeCursor(2, [
