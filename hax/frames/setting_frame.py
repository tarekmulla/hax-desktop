...
from database.setting import get_all_setting, update_setting
...
class SettingFrame(BaseFrame):
  ...
  def __init_frame__(self):
    ...
    self.add_button("Save", command=self.save_setting).grid(row=2, column=1)
  ...
  def save_setting(self):
    ...
    update_setting("TestSetting2", "VALUE2")
